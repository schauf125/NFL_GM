...
def _insert_prospect(
    ...
    values = {
        ...
        "name_pronunciation_note": row.name_pronunciation_note,
        "name_background_note": row.name_background_note,
        "family_football_type": row.family_football_type,
        "family_football_background": row.family_football_background,
        "name_storyline_note": row.name_storyline_note,
        ...
        "jawline": row.jawline,
        "brow_profile": row.brow_profile,
        "nose_profile": row.nose_profile,
        "smile_profile": row.smile_profile,
        "media_style": row.media_style,
        "accessory_style": row.accessory_style,
