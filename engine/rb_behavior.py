...
RB_STYLE_OVERRIDES: dict[str, RBBehaviorProfile] = {
    ...
    "ashton jeanty": profile("Developing Contact Creator", 72, 72, 76, 62, 72, 76, 70, 58, 70, 72),
    ...
    "christian mccaffrey": profile("Veteran Space Mismatch", 84, 86, 82, 60, 70, 56, 90, 86, 62, 84),
