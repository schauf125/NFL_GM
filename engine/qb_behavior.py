...
QB_STYLE_OVERRIDES: dict[str, QBBehaviorProfile] = {
    ...
    "brock purdy": profile("Timing Distributor", 84, 78, 42, 68, 54, 62, 66, 42, 40, 70),
    ...
    "kirk cousins": profile("Static Timing Veteran", 82, 84, 22, 66, 48, 22, 30, 8, 58, 72),
    ...
    "matthew stafford": profile("Trust-Throw Pocket Artist", 86, 82, 38, 44, 88, 34, 70, 12, 60, 54),
    ...
    "shedeur sanders": profile("Composed Pocket Rookie", 66, 70, 38, 58, 52, 44, 56, 24, 58, 58),
    ...
    "tua tagovailoa": profile("Anticipation Distributor", 88, 80, 26, 76, 40, 34, 42, 10, 44, 76),
