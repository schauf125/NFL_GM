...
QB_PROFILES: dict[tuple[str, str, str], dict[str, object]] = {
    ("Matthew", "Stafford", "LAR"): profile(94, 93, 92, 91, 91, 87, 93, 94, 95, 93, 52, 55, 58, 50, 78, 42, "AP MVP, first-team All-Pro, and PFF's top 2025 QB."),
    ...
    ("Brock", "Purdy", "SF"): profile(91, 88, 86, 87, 87, 83, 87, 89, 89, 87, 72, 74, 72, 70, 78, 48, "Efficient starter with injury volatility and less elite physical profile."),
    ...
    ("Kirk", "Cousins", "LV"): profile(82, 80, 78, 78, 82, 76, 83, 84, 82, 80, 45, 46, 48, 45, 76, 42, "Veteran processor, declining mobility and arm strength."),
    ...
    ("Tua", "Tagovailoa", "ATL"): profile(82, 80, 78, 80, 82, 76, 79, 80, 78, 76, 58, 58, 60, 58, 72, 38, "Accuracy respected while injury/turnover concerns pull him down."),
    ...
    ("Shedeur", "Sanders", "CLE"): profile(80, 78, 77, 84, 80, 76, 78, 79, 79, 76, 66, 67, 68, 66, 75, 55, "Accurate, composed prospect profile without elite physical tools."),
